...
class TablaPreinscripcion extends DataTableComponent
{
    public $empresas;
    ...
    {
        return Preinscripcion::query()->where('preins', '1');
    }
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Cédula', 'estudiante_ci')
                ->sortable()
                ->searchable(),
            ...
            Column::make('Acciones')->label(fn ($row) => view('livewire.preinscripcion-acciones')->with([

                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body p-4">
                            ...
                            {!! Form::open(['route' => 'usuarios.store', 'method' => 'POST', 'class' => 'needs-validation', 'novalidate']) !!}
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <input type="tel" class="form-control col-md-12" id="Ci" name="Ci"
                                            ...
                                            tabindex="1" onkeypress="return numeros(event);" required>
                                ...
                                <div class="col-xs-3 col-sm-3 col-md-3">
                                    <div class="form-group mt-4">
                                        ...
                                        {!! Form::select(
                                            ...
                                            $roles,
                                            [],
                                            ['class' => 'form-select', 'placeholder' => '-- Elija una opción --', 'required'],
                                        ) !!}
                                        <div class="invalid-feedback">

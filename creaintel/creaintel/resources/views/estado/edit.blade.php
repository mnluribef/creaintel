                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body ml-3">
                            <form action="/estado/{{ $estados->id }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control col-md-7" id="nombre_estado"
                                            name="nombre_estado" maxlength="20" value="{{ $estados->nombre_Estado }}"
                                            tabindex="2" required>
                                    </div>

...
<head>
    ...
    <table id="preinscripcion" class=" table table-striped shadow-lg mt-4" style="width:100%">
        <thead class="bg-primary text-white">
            <tr>
                <th scope="col">ID</th>
                <th scope="col">Estudiante Ci</th>
                <th scope="col">Sede</th>
                <!--                 <th scope="col">Sede</th>
                <th scope="col">Tipo Estudio</th>
                <th scope="col">Trayecto</th>
                <th scope="col">Título Tentativo</th>
        ...
        <tbody>
            @foreach ($preinscripciones as $preinscripcion)
                <tr>
                    ...
                    <td>{{ $preinscripcion->preins_sede['nombre_Sede'] }}</td>
                    <td></td>


                    <td>
                        <button type="submit" class="btn btn-warning" onclick="javascript:return popup_inactivar();"><i
                                class="fa-solid fa-ban fa-fw"></i>
                        </button>
                        </form>
                    </td>
                </tr>

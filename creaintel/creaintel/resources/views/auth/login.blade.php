    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate>
            ...
            <div>
                ...
                <x-jet-input id="ci" class="block mt-1 w-full" type="tel" minlength="7" maxlength="8"
                    name="ci" :value="old('ci')" onkeypress="return numeros(event);" required autofocus />
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="password" class="block mt-1 w-full" type="password"
                    onKeyPress="if(this.value.length==15) return false;" name="password" required

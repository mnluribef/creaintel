                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body p-4">
                            <fieldset class="border border-primary border-2 p-3 rounded">
                                <form action="/docente" method="POST" class="ml-3">
                                    @csrf

                                    <h4 class="text-center text-primary">Datos del Docente</h4>

                                    <label for="docente_ci" class="mt-4">Cédula</label>
                                    <input type="number" class="form-control col-md-2" id="docente_ci" name="docente_ci"
                                        placeholder="Ej: 25617543" maxlength="100" tabindex="1"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control col-md-9" id="apellido"
                                                name="apellido" placeholder="Ej: Pérez" maxlength="50" tabindex="3"
                                                onkeypress="return txt(event);" required>
                                        </div>
                                        ...
                                        <div class="col">
                                            ...
                                            <div label for="prefijo_id"></label>
                                                ...
                                                <input type="number" min="1"
                                                    ...
                                                    name="telefono" placeholder="Ej: 5432132" tabindex="5" maxlength="7"
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            ...
                                            <select name="PNF_id" id="PNF_id" tabindex="6"
                        ...
                        <div class="card-footer mt-4">
                            <button type="submit" class="btn btn-primary mr-3" tabindex="8"
                                onclick="validarGuardar();">Guardar</button>
                            <a class="btn btn-secondary" tabindex="9" onclick="validarCancelar();">Cancelar</a>
                        </div>
                        </fieldset>
                        </form>

        ...
        <tbody>
            @foreach ($estudiante as $estudiante)
                <tr>
                    ...
                    <td>{{ $estudiante->estudiante_PNF['nombre_PNF'] }}</td>
                    ...
                    <td>
                        ...
                        @can('editar-estudiante')
                            <a href="/estudiante/{{ $estudiante->estudiante_ci }}/edit" data-toggle="tooltip"
                                data-placement="top" title="Editar" class="btn btn-success mr-2"><i
                                    class="fa-solid fa-pen-to-square fa-fw"></i></a>
                        @endcan

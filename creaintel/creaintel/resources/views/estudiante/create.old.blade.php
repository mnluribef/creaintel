                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body p-4">
                            <fieldset class="border border-primary border-2 p-3 rounded">
                                <form action="/estudiante" method="POST" id="registro">
                                    @csrf
                                    <h4 class="text-center text-primary">Datos del Estudiante</h4>
                                    <div class="form-row">
                                        <div class="col">
                                            <label for="estudiante_ci" class="mt-4">Cédula</label>
                                            <input type="number" class="form-control col-md-2" id="estudiante_ci"
                                                name="estudiante_ci" placeholder="Ej: 25617543" maxlength="8"
                                                tabindex="1" onKeyPress="if(this.value.length==8) return false;"
                                                onkeypress="return cedula(event);" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control col-md-9" id="nombre"
                                                name="nombre" placeholder="Ej: Juan" maxlength="50" tabindex="2"
                                                onkeypress="return txt(event);" required>
                                        </div>

                                        <div class="col">
                                            <label for="apellido" class="mt-4">Primer Apellido</label>
                                            <input type="text" min="1" class="form-control col-md-9"
                                                id="apellido" name="apellido" placeholder="Ej: Pérez" maxlength="50"
                                                tabindex="3" onkeypress="return txt(event);" required>
                                        </div>

                                        <div class="col">
                                            <label for="correo" class="mt-4">Correo</label>
                                            <input type="email" class="form-control col-md-9" id="correo"
                                                name="correo" placeholder="Ej: ejemplo@gmail.com" maxlength="50"
                                                tabindex="4" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            ...
                                            <div label for="prefijo_id"></label>
                                                <select name="prefijo_id" id="prefijo_id" tabindex="5"
                                                ...
                                                <input type="number" min="1"
                                                    class="form-control col-md-4 d-inline-block" id="telefono"
                                                    name="telefono" placeholder="Ej: 5432132" tabindex="6" maxlength="7"
                                                    required onKeyPress="if(this.value.length==7) return false;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col">
                                            ...
                                            <select name="lider_id" id="lider_id" tabindex="7"

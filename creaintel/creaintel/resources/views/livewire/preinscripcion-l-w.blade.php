<div>
    ...
    <button wire:click="incrementCounter">Incrementar</button>
                                                        ...
                                                        <div class="bs-stepper-header" role="tablist">
                                                            ...
                                                            <div class="step" data-target="#information-part">
                                                                <button type="button" class="step-trigger" role="tab"
                                                                    ...
                                                                    <span class="bs-stepper-label">Datos de la
                                                                        Comunidad</span>
                                                                </button>
                                                            </div>
                                                            <div class="line"></div>
                                                            <div class="step" data-target="#planilla-part">
                                                                <button type="button" class="step-trigger" role="tab"
                                                                    aria-controls="planilla-part"
                                                                    id="planilla-part-trigger">
                                                            ...
                                                            <div class="step" data-target="#planilla2-part">
                                                                <button type="button" class="step-trigger" role="tab"
                                                                    aria-controls="planilla2-part"
                                                                    id="planilla2-part-trigger">
                                                            ...
                                                            <div class="step" data-target="#planilla3-part">
                                                                <button type="button" class="step-trigger" role="tab"
                                                                    aria-controls="planilla3-part"
                                                                    id="planilla3-part-trigger">
                                                                    <span class="bs-stepper-circle">4</span>
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="col">
                                                                        <label for="estudiante_ci"
                                                                            class="mt-4 required">Líder del Equipo</label>
            ...
            <option value="">Selecciona una ciudad</option>
                                                                ...
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <select required name="trayecto_id"
                                                                            id="trayecto_id" class="form-select col-md-9"
                                                                            style="display:flex">
                                                                            <option value="">-- Escoja una opción --
                                                                            </option>
                                                            ...
                                                            <div id="information-part" class="content" role="tabpanel"
                                                                ...
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <select required name="municipio_id"
                                                                            id="municipio_id" class="form-select col-md-9"
                                                                            style="display:flex">
                                                                            <option value="">-- Escoja una opción --
                                                                            </option>
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <select required name="parroquia_id"
                                                                            id="parroquia_id" class="form-select col-md-9"
                                                                            style="display:flex">
                                                                            <option value="">-- Escoja una opción --
                                                                            </option>
                                                                ...
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="col">
                                                                        <label for="asesor_ci"
                                                                            class="mt-4 required">Docente Asesor</label>
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="col">
                                                                        ...
                                                                        <select required name="lineainve_id"
                                                                            id="lineainve_id" class="form-select col-md-6"
                                                                            style="display:flex">
                                                                            <option value="">-- Escoja una opción --
                                                                            </option>
                                                            ...
                                                            <div id="planilla-part" class="content" role="tabpanel"
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="titulo_Tentativo"
                                                                        class="mt-4 required">Título del Proyecto </label>
                                                            ...
                                                            <div id="planilla3-part" class="content" role="tabpanel"
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="aportes_comu"
                                                                        class="mt-4 required">Aportes a la Comunidad,
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="acciones_integra"
                                                                        class="mt-4 required">Acciones de Integración con
                                                                        la Comunidad</label>
                                    ...
                                    <div class="card-footer mt-4">
                                        ...
                                        <a class="btn btn-secondary" tabindex="5"
                                            onclick="validarCancelar();">Cancelar</a>
                                    </div>

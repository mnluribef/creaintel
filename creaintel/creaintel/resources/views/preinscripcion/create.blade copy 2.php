                                                    ...
                                                    <div id="logins-part" class="content" role="tabpanel" aria-labelledby="logins-part-trigger">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col">
                                                                ...
                                                                <select name="estudiante_ci" id="estudiante_ci" class="form-select col-md-9" required>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col">
                                                                ...
                                                                <select required name="sede" id="sede" class="form-select col-md-9" style="display: flex">
                                                                    <option value="">-- Escoja una opción --</option>
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <div class="form-group mt-4">
                                                                    <select id="PNF" name="PNF" class="form-control">
                                                                    </select>
                                                                </div>
...
<select name="city" id="city">
    <option value="">Selecciona una ciudad</option>
                                                                ...
                                                                <select required name="PNF_id" id="PNF_id" class="form-select col-md-9" style="display:flex">
                                                                    <option value="">-- Escoja una opción --</option>
                                                                    @foreach ($pnfs as $pnf)
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <select required name=" tipo_estudio_id" id="tipo_estudio_id" class="form-select col-md-9">
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <select required name="trayecto_id" id="trayecto_id" class="form-select col-md-9" style="display:flex">
                                                                    <option value="">-- Escoja una opción --</option>
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <select required name="seccion_id" id="seccion_id" class="form-select col-md-9" style="display:flex">
                                                                    <option value="">-- Escoja una opción --</option>
                                                    ...
                                                    <div id="information-part" class="content" role="tabpanel" aria-labelledby="information-part-trigger">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col">
                                                                ...
                                                                <select required name="estado_id" id="estado_id" class="form-select col-md-9" style="display:flex">
                                                                    <option value="">-- Escoja una opción --</option>
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <select required name="municipio_id" id="municipio_id" class="form-select col-md-9" style="display:flex">
                                                                    <option value="">-- Escoja una opción --</option>
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <select required name="parroquia_id" id="parroquia_id" class="form-select col-md-9" style="display:flex">
                                                                    <option value="">-- Escoja una opción --</option>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col">
                                                                ...
                                                                <select required name="sector_id" id="sector_id" class="form-select col-md-9" style="display:flex">
                                                                    <option value="">-- Escoja una opción --</option>
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <select required name="asesor_ci" id="asesor_ci" class="form-select col-md-9" style="display:flex">
                                                                    <option value="">-- Escoja una opción --</option>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col">
                                                                ...
                                                                <select required name="lineainve_id" id="lineainve_id" class="form-select col-md-6" style="display:flex">
                                                                    <option value="">-- Escoja una opción --</option>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(id, value) {
                        pnf_dropdown.append('<option value="' + id + '">' + value + '</option>');
                    });
                },

...
<a id="preinscribir" href="{{ route('preinscribir') }}" class="btn btn-primary mt-4 mb-4"><i class="fa-solid fa-plus fa-fw"></i>Agregar</a>
@endcan
        ...
        <tr>
            ...
            <td>
                <form action="{{ route ('preinscripcion.destroy',$preinscripcion->id)}}" method="POST" id="miFormulario">
                    ...
                    <a href="{{ route('PreinscripcionPDF', ['id' => $preinscripcion->id]) }}" target="_blank" data-toggle="tooltip" data-placement="top" title="Reporte" class="btn btn-danger mr-2"><i class="fa-solid fa-file-pdf fa-fw"></i></a>
